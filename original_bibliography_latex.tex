...
\textit{Epilepsia}, vol. 61, no. 2, pp. 269--277, 2020.
[Online]. Available: \url{https://doi.org}

\bibitem{Kasarinaite2023}
A. Kasarinaite et al.,
``The Influence of the Menstrual Cycle on Pharmacokinetics: A Systematic Review,''
\textit{Clinical Pharmacokinetics}, vol.~62, no.~6, pp.~817--833, 2023.
[Online]. Available: \url{https://doi.org/10.1007/s40262-023-01248-w}

\bibitem{Stricker2006}
R. B. Stricker et al.,
``The menstrual cycle and drug metabolism,''
\textit{Pharmacogenomics}, vol.~7, no.~6, pp.~877--885, 2006.

\bibitem{Reimers2005}
A. Reimers, G. Helde, and E. Brodtkorb,
``Ethinyl estradiol, not progestogens, reduces lamotrigine serum concentrations,''
\textit{Epilepsia}, vol.~46, no.~9, pp.~1414--1417, 2005.
[Online]. Available: \url{https://doi.org/10.1111/j.1528-1167.2005.05804.x}

\bibitem{Pennell2008}
P. B. Pennell et al.,
``The impact of pregnancy and childbirth on the metabolism of lamotrigine,''
\textit{Neurology}, vol.~62, no.~2, pp.~292--295, 2004.
[Online]. Available: \url{https://doi.org/10.1212/01.WNL.0000103286.47129.F4}
...
\textit{British J. Pharmacology}, vol.~171, no.~3, pp.~580--594, 2014.
...
\textit{Clinical Pharmacology \& Therapeutics}, vol. 110, no. 3, pp. 563--572, 2021.
[Online]. Available: \url{https://doi.org}

\bibitem{Lexicomp2026}
Lexicomp,
``Lexi-Drugs Online Database,''
\textit{UpToDate Lexidrug}, Wolters Kluwer Health, Inc., Riverwoods, IL, 2026.
[Online]. Available: \url{https://lexi.com}

\bibitem{Micromedex2026}
IBM Micromedex,
``Micromedex DrugRef Database,''
\textit{Truven Health Analytics}, IBM Watson Health, Greenwood Village, CO, 2026.
[Online]. Available: \url{https://micromedexsolutions.com}

\bibitem{DrugsDotCom2026}
Drugs.com,
``Drugs.com Drug Information Database,''
\textit{Drug Site Trust}, Auckland, New Zealand, 2026.
[Online]. Available: \url{https://drugs.com}
